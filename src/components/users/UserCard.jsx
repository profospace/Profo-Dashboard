...
// const UserCard = ({ user, onDeleteUser, isTracked = false, trackedUsers, onTrackingChange }) => {
//     const navigate = useNavigate();
//     const [isTrackingLoading, setIsTrackingLoading] = useState(false);
//     const [trackingStatus, setTrackingStatus] = useState(isTracked);

//     console.log("trackedUsers", trackedUsers)
...
const UserCard = ({ user, onDeleteUser, trackedUsers = [], onTrackingChange }) => {
    const navigate = useNavigate();
    const [isTrackingLoading, setIsTrackingLoading] = useState(false);

    // Determine if user is tracked based on trackedUsers array
    const isTracked = useMemo(() => {
        return trackedUsers.some(trackedUser => trackedUser.id === user._id);
    }, [trackedUsers, user._id]);
    ...
    // Update trackingStatus when isTracked changes
    React.useEffect(() => {
