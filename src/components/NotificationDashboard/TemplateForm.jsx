        ...
        try {
            ...
            if (template && template._id) {
                ...
                response = await axios.put(
                    `${base_url}/api/notifications/admin/templates/${template._id}`,
                    formData,
                    getAuthConfig()
                );
            } else {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-modal">
                ...
                <form onSubmit={handleSubmit} className="p-4">
                    ...
                    {/* Template Selector for autofill - only show for new templates */}
                    {!template && <TemplateSelector onSelectTemplate={handleSelectTemplate} />}
