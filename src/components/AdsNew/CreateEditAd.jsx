...
//         header: '',
//         pagelink: '',
//         // Updated structure for middle section
//         middle: {
//             layout: 'single',
//             maxItemsPerRow: 1,
//             cards: []
//         },
//         // Updated structure for bottom CTA
//         bottomCta: {
//             imageUrl: '',
//             deepLink: ''
//         },
...
//             setFormData({
//                 ...editingAd,
//                 // Ensure middle structure exists
//                 middle: editingAd.middle || {
//                     layout: 'single',
//                     maxItemsPerRow: 1,
//                     cards: []
//                 },
//                 // Ensure bottomCta structure exists
//                 bottomCta: editingAd.bottomCta || {
//                     imageUrl: '',
//                     deepLink: ''
//                 },
//                 contact: editingAd.contact?.length > 0 ? editingAd.contact : [''],
...
//                     alert('Valid delay is required for POPUP ads');
//                     return;
//                 }
//             }
...
//                 ...formData,
//                 contact: formData.contact.filter(contact => contact.trim() !== ''),
//                 // Ensure middle cards are properly formatted
//                 middle: {
//                     ...formData.middle,
...
//     // Add new card to middle section
//     const addMiddleCard = () => {
//         const newCard = { imageUrl: '', deepLink: '' };
//         updateFormData('middle.cards', [...formData.middle.cards, newCard]);
//     };

//     // Remove card from middle section
//     const removeMiddleCard = (index) => {
//         const newCards = formData.middle.cards.filter((_, i) => i !== index);
//         updateFormData('middle.cards', newCards);
//     };

//     // Update specific card in middle section
//     const updateMiddleCard = (index, field, value) => {
...
//                                 <button
//                                     type="button"
//                                     onClick={() => removeMiddleCard(index)}
...
//                                         type="url"
//                                         value={card.imageUrl}
//                                         onChange={(e) => updateMiddleCard(index, 'imageUrl', e.target.value)}
//                                         placeholder="Enter image URL"
...
//                                         type="url"
//                                         value={card.deepLink}
//                                         onChange={(e) => updateMiddleCard(index, 'deepLink', e.target.value)}
...
//                     {/* Map View Placeholder - Replace with your MapView component when available */}
//                     <div>
//                         <h4 className="text-sm font-medium text-gray-700 mb-4">Select Location on Map</h4>
...
//                                 Current location: {formData.locationTargeting.center.latitude}, {formData.locationTargeting.center.longitude}
//                             </p>
//                         </div>
//                     </div>
//                 </div>
