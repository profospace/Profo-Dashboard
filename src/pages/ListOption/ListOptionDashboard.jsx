...
// import {
//     Plus, X, Image, Save, Upload, Edit, Trash2, Eye,
...
//                 // Check other property filters as needed
//                 // For example, bedrooms, price range, etc.
...
//                             <div>
//                                 <label className="block text-sm font-medium text-gray-700 mb-1">
//                                     List Name* <span className="text-xs text-gray-500">(unique identifier)</span>
//                                 </label>
//                                 <input
//                                     type="text"
...
//                                     className="w-full p-2 border border-gray-300 rounded-md"
//                                 >
//                                     <option value="propertyList">Property List</option>
//                                     <option value="projectList">Project List</option>
//                                     <option value="buildingList">Building List</option>
...
//                                 setBackgroundColor={(color) => handleInputChange('backgroundColor', color)}
//                             />
//                         </div>
//                     </div>

//                     {/* Entity and Data Settings */}
//                     <div className="bg-white p-4 rounded-lg shadow-sm">
//                         <h2 className="text-lg font-semibold text-gray-800 mb-4">Entity and Data Settings</h2>
...
//                                     onChange={(e) => handleInputChange('useGeolocation', e.target.checked)}
...
//                                         onChange={(e) => handleInputChange('defaultRadius', parseInt(e.target.value, 10))}
//                                         min="1"
//                                         max="100"
//                                         className="w-full p-2 border border-gray-300 rounded-md"
//                                     />
...
//                         {/* Sort settings */}
//                         <div className="mt-4">
//                             <h3 className="font-medium text-gray-800 mb-2">Sort Settings</h3>
//                             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                                 <div>
//                                     <label className="block text-sm font-medium text-gray-700 mb-1">
//                                         Sort By Field
//                                     </label>
//                                     <select
//                                         value={formData.sortBy.field}
//                                         onChange={(e) => handleNestedChange('sortBy', 'field', null, e.target.value)}
//                                         className="w-full p-2 border border-gray-300 rounded-md"
//                                     >
...
//                                         <option value="visted">Most Visited</option>
//                                     </select>
//                                 </div>
...
//                                     </label>
//                                     <select
//                                         value={formData.sortBy.order}
//                                         onChange={(e) => handleNestedChange('sortBy', 'order', null, e.target.value)}
//                                         className="w-full p-2 border border-gray-300 rounded-md"
//                                     >
...
//                                 {formData.entityType === 'property' ? 'Property Filters' :
//                                     formData.entityType === 'project' ? 'Project Filters' : 'Building Filters'}
//                             </h2>
...
//                                             checked={formData.filters.property.type.enabled}
//                                             onChange={() => toggleFilterEnabled('property', 'type')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-property-type" className="text-sm font-medium text-gray-700">
//                                             Property Type
//                                         </label>
//                                     </div>
...
//                                             type="checkbox"
//                                             id="filter-bedrooms"
//                                             checked={formData.filters.property.bedrooms.enabled}
//                                             onChange={() => toggleFilterEnabled('property', 'bedrooms')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-bedrooms" className="text-sm font-medium text-gray-700">
//                                             Bedrooms
//                                         </label>
//                                     </div>
...
//                                             type="checkbox"
//                                             id="filter-price"
//                                             checked={formData.filters.property.price.enabled}
//                                             onChange={() => toggleFilterEnabled('property', 'price')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-price" className="text-sm font-medium text-gray-700">
//                                             Price Range
//                                         </label>
//                                     </div>
...
//                                             type="checkbox"
//                                             id="filter-area"
//                                             checked={formData.filters.property.area.enabled}
//                                             onChange={() => toggleFilterEnabled('property', 'area')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-area" className="text-sm font-medium text-gray-700">
//                                             Area
//                                         </label>
//                                     </div>
...
//                                             checked={formData.filters.property.furnishing.enabled}
//                                             onChange={() => toggleFilterEnabled('property', 'furnishing')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-furnishing" className="text-sm font-medium text-gray-700">
//                                             Furnishing
//                                         </label>
//                                     </div>
//                                 </div>
...
//                             {formData.filters.property.type.enabled && (
//                                 <div className="ml-6 mt-2 p-3 border border-gray-200 rounded-md bg-gray-50">
//                                     <label className="block text-sm font-medium text-gray-700 mb-2">
//                                         Select Property Types
//                                     </label>
//                                     <div className="space-y-2">
//                                         {['Apartment', 'Villa', 'Shops', 'Warehouses', 'Halls'].map(type => (
//                                             <div key={type} className="flex items-center">
//                                                 <input
//                                                     type="checkbox"
//                                                     id={`type-${type}`}
//                                                     checked={formData.filters.property.type.values.includes(type)}
//                                                     onChange={(e) => {
//                                                         const currentValues = [...formData.filters.property.type.values];
//                                                         if (e.target.checked) {
...
//                                                                 ...formData.filters,
//                                                                 property: {
//                                                                     ...formData.filters.property,
//                                                                     type: {
//                                                                         ...formData.filters.property.type,
...
//                                             checked={formData.filters.project.type.enabled}
//                                             onChange={() => toggleFilterEnabled('project', 'type')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-project-type" className="text-sm font-medium text-gray-700">
//                                             Project Type
//                                         </label>
//                                     </div>
...
//                                             checked={formData.filters.project.status.enabled}
//                                             onChange={() => toggleFilterEnabled('project', 'status')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-project-status" className="text-sm font-medium text-gray-700">
//                                             Status
//                                         </label>
//                                     </div>
...
//                                             checked={formData.filters.project.priceRange.enabled}
//                                             onChange={() => toggleFilterEnabled('project', 'priceRange')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-price-range" className="text-sm font-medium text-gray-700">
//                                             Price Range
//                                         </label>
//                                     </div>
//                                 </div>
...
//                                             checked={formData.filters.building.type.enabled}
//                                             onChange={() => toggleFilterEnabled('building', 'type')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-building-type" className="text-sm font-medium text-gray-700">
//                                             Building Type
//                                         </label>
//                                     </div>
...
//                                             checked={formData.filters.building.status.enabled}
//                                             onChange={() => toggleFilterEnabled('building', 'status')}
//                                             className="h-4 w-4 text-blue-600 border-gray-300 rounded mr-2"
//                                         />
//                                         <label htmlFor="filter-building-status" className="text-sm font-medium text-gray-700">
//                                             Status
//                                         </label>
//                                     </div>
//                                 </div>
...
import {
    ...
    Copy, CheckCircle, Home, Building, Briefcase, List,
    Filter, Search, Sliders, MapPin, DollarSign, Square
} from 'lucide-react';
import { base_url } from "../../../utils/base_url";
import ColorPicker from '../../components/ColorPicker';
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="bg-white p-4 rounded-lg shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    {/* This section should contain all your form fields for title, subtitle, headerImage, etc. */}
                                    {/* Also include the Display Settings, Entity and Data Settings, and Entity-specific Filters sections */}

                                    {/* Custom Options (for entityType 'custom') - This should be inside the create form */}
                                    {formData.entityType === 'custom' && (
