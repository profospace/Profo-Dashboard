...
const AndroidPageDashboard = () => {
    ...
    const deleteHorizontalList = (listId) => {
        ...
        const updatedPage = {
            ...selectedPage,
            horizontalLists: selectedPage.horizontalLists.filter(
                (list) => list.id !== listId
            ),
        };
        updatePage(updatedPage);
        ...
        const updatedPage = {
            ...
            horizontalLists: selectedPage.horizontalLists.map((list) =>
                list.id === listId
                    ? {
                          ...list,
                          images: list.images.filter((_, index) => index !== imageIndex),
                      }
                    : list
            ),
        };
    ...
    const AndroidPreview = ({ page }) => (
        <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-sm mx-auto">
            <div className="p-4" style={{ backgroundColor: page.backgroundColor }}>
                <h1
                    className="text-2xl font-bold mb-4 text-center"
                    style={{ color: page.titleColor }}
                >
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                {/* ... existing page list / actions code stays unchanged ... */}

                {selectedPage && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {/* Page Editor code unchanged */}
                            ...
                            <div className="space-y-4 max-h-96 overflow-y-auto">
                                {selectedPage.horizontalLists.map((list) => (
                                    ...
                                    >
                                        ...
                                        {/* Image Editor remains unchanged */}
                                        <div className="space-y-2 mb-3">
                                            {list.images.map((image, index) => (
                                                <div
                                                    key={index}
