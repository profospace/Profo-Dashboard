...
const AndroidPageDashboard = () => {
    ...
    const addHorizontalList = () => {
        ...
        const newList = {
            ...
            title: 'New List',
            titleColor: '#374151',
            type: 'vertical', // Default to vertical as per schema
            images: []
        };
        const updatedPage = {
            ...selectedPage,
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {selectedPage && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-bold text-gray-800">Lists</h3>
                                <button
                                    onClick={addHorizontalList}
                                    className="bg-green-600 text-white px-3 py-1 rounded text-sm flex items-center gap-1 hover:bg-green-700"
                                >
                                ...
                                {selectedPage.horizontalLists.map((list) => (
                                    <div key={list.id} className="border border-gray-200 rounded-lg p-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mb-3">
                                            ...
                                            <div>
                                                <label className="block text-xs text-gray-600 mb-1">List Type</label>
                                                <div className="flex gap-2">
                                                    <label className="flex items-center gap-1">
                                                        <input
                                                            ...
                                                            name={`type-${list.id}`}
                                                            value="horizontal"
                                                            checked={list.type === 'horizontal'}
                                                            onChange={(e) => updateHorizontalList(list.id, { ...list, type: e.target.value })}
                                                            className="w-3 h-3"
                                                        />
