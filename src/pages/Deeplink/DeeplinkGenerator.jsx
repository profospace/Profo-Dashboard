...
const DeeplinkGenerator = () => {
    ...
    const fieldOptions = {
        ...
        loanApprovalStatus: ['SBI Approved', 'HDFC Approved', 'ICICI Approved', 'Axis Bank Approved', 'PNB Approved', 'BOI Approved', 'Kotak Approved', 'LIC Housing Approved', 'DHFL Approved', 'Indiabulls Approved', 'Pre-approved by Major Banks', 'Easy Loan Processing', '90% Loan Available', '85% Loan Approved', 'Government Bank Approved', 'Private Bank Approved'],
