...
const AdForm = () => {
        ...
        if (isEditMode) {
            const fetchAd = async () => {
                try {
                    ...
                    // Make sure we have data and it matches our expected format
                    if (response.data && response.data.data) {
                        ...
                        const formattedData = {
                            ...
                            type: {
                                ...
                                ...(adData.type || {}),
                                location: {
                                    ...initialFormState.type.location,
                                    ...(adData.type?.location || {})
                                }
                            },
                            targeted_audience: {
                                ...initialFormState.targeted_audience,
                                ...(adData.targeted_audience || {}),
                                ageRange: {
                                    ...initialFormState.targeted_audience.ageRange,
                                    ...(adData.targeted_audience?.ageRange || {})
                                }
                            }
                        };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Submit data
            if (isEditMode) {
                const response = await axios.put(`${base_url}/ads/${id}`, submissionData);
                if (response.data) {
                    setSuccess('Ad updated successfully!');
                }
            } else {
                const response = await axios.post(`${base_url}/ads`, submissionData);
                if (response.data) {
                    setSuccess('Ad created successfully!');
                    setFormData(initialFormState); // Reset form after successful creation
                }
        ...
        <div className="mx-auto">
            ...
            <form onSubmit={handleSubmit} className="pb-8 mb-4">
                <div className="mb-6">
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="pagelink">
                            Page Redirection Navigation Link
                        </label>
                        <input
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="pagelink"
